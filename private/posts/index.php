...
<head>
  ...
  <title>Admin Area - Manage Posts</title>
      <!-- Favicon -->
          ...
          <tbody>
            <?php foreach ($posts as $key => $post): ?>
              <tr>
                ...
                <td><?php echo $post['total_views'] ?></td>
                <td><a target="_blank" href="singlePreview.php?id=<?php echo $post['id']; ?>" class="view">preview</a></td>
                <!--<td><a target="_blank" href="<?php //echo BASE_URL . '/private/posts/singlePreview.php?id=' . $post['id']; ?>" class="view">preview</a></td>-->
