                    ...
                    <tbody>
                        <?php foreach ($users_detail as $key => $user): ?>
                            <tr>
                                ...
                                <?php if($user['admin']): ?>
                                    <td>Admin</td>
                                    <td><a href="edit.php?admin=0&u_id=<?php echo $user['id']; ?>" class="unpublish">Unmake Admin</a></td>
                                    <?php else: ?>
                                    <td>Member</td>
                                    <td><a href="edit.php?admin=1&u_id=<?php echo $user['id']; ?>" class="publish">Make Admin</a></td>
                                <?php endif; ?> 
